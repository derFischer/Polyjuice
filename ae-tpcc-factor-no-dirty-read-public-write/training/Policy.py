...
class Sample:
    ...
    def align_standard_algo(self):
        self.access = [0] * ACCESSE_SPACE
        self.wait = [0] * WAIT_SPACE
        self.wait_info1 = [txn_accesses[0]] * WAIT_SPACE
        self.wait_info2 = [txn_accesses[1]] * WAIT_SPACE
        self.wait_info3 = [txn_accesses[2]] * WAIT_SPACE
...
class Policy:
    ...
    def table_sample(self, file = None):
        ...
        sample = Sample(access, wait, piece, wait_info1, wait_info2, wait_info3, 4, [0] * CONTENTION_LEVEL * TXN_TYPE, [63] * CONTENTION_LEVEL * TXN_TYPE)
