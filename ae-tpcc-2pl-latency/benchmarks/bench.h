...
extern void tpcc_2pl_do_test(abstract_db *db, int argc, char **argv);
...
extern void micro_badcount_do_test(abstract_db *db, int argc, char **argv);

extern void micro_locking_do_test(abstract_db *db, int argc, char **argv);

extern void micro_pieces_do_test(abstract_db *db, int argc, char **argv);
