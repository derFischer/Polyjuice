...
static string
ic3_version_str(uint64_t v) UNUSED;
static string
ic3_version_str(uint64_t v)
{
  ostringstream b;
  b << "[core=" << transaction_ic3_static::CoreId(v) << " | n="
    << transaction_ic3_static::NumId(v) << " | epoch="
    << transaction_ic3_static::EpochId(v) << "]";
  return b.str();
}

// XXX(stephentu): hacky!
string (*g_proto_version_str)(uint64_t v) = ic3_version_str;
