...
void CGenerateAndLoad::GenerateAndLoadHoldingAndTrade()
{
    ...
    do
    {
        ...
        pTradesLoad->SetOrder();
        pSettlementLoad->SetOrder();
        pHistoryLoad->SetOrder();
        pCashLoad->SetOrder();
        pBrokerLoad->SetOrder();
        pHoldingHistoryLoad->SetOrder();
        pHoldingsLoad->SetOrder();
        pHoldingSummaryLoad->SetOrder();
...
void CGenerateAndLoad::GenerateAndLoadNewsItemAndNewsXRef()
{
    ...
    pNewsItemLoad->SetOrder();
    pNewsXRefLoad->SetOrder();
...
void CGenerateAndLoad::GenerateAndLoadWatchListAndWatchItem()
{
    ...
    pWatchListsLoad->SetOrder();
    pWatchItemsLoad->SetOrder();
