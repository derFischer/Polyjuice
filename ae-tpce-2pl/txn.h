...
protected:
  ...
  typedef static_vector<
    lock_record_t,
    traits_type::write_set_expected_size> lock_set_map_static;
...
protected:
  ...
  bool
  do_tuple_read(const dbtuple *tuple, ValueReader &value_reader, bool readonly = false);
...
protected:
  ...
  inline void release_read_lock(dbtuple* tuple)
  {
