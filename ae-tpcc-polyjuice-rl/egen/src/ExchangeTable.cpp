...
{
    // There are 685 securities per Load Unit. The flat_in/Security.txt contains 10 LUs worth of
    // securities. This array is a pre-computation of the cumulative number of securities each
    // excahnge has in the first 10 LUs.
