...
public:
    ...
    void Set(INT32 year, INT32 month, INT32 day);                       // set to specified date; time set to 0:00:00 (midnight)
    void Set(INT32 hour, INT32 minute, INT32 second, INT32 msec);       // set to specified time, date not changed.
    ...
    {
        return ((UINT64)m_dayno) << 32 | ((UINT64)m_msec);
    }
};
