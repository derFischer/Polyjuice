...
namespace TPCE
{
    ...
    public:
        CCompanyCompetitorTable(const DataFileManager &dfm,
            ...
            , m_CompanyCompetitorFile(dfm.CompanyCompetitorFile())
        {
            ...
            m_iCompanyCompetitorCountForOneLoadUnit = m_CompanyCompetitorFile.CalculateCompanyCompetitorCount(iDefaultLoadUnitSize);
        };
