...
#include "../inc/EGenInputFilesTester.h"
...
init_function()
{
	...
	boost::unit_test::framework::master_test_suite().p_name.set("EGenInputFiles Master Test Suite");

	// Load EGenInputFiles Test Suite
	TestSuiteBuilder< EGenInputFilesTestSuite > utilitiesTestSuite("EGenInputFiles Test Suite");
