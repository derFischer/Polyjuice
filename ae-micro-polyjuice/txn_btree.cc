...
{
  cerr << "Test ic3" << endl;
  test_typed_btree<transaction_ic3, default_stable_transaction_traits>();
  test1<transaction_ic3, default_transaction_traits>();
  test2<transaction_ic3, default_transaction_traits>();
  test_absent_key_race<transaction_ic3, default_transaction_traits>();
  test_inc_value_size<transaction_ic3, default_transaction_traits>();
  test_multi_btree<transaction_ic3, default_transaction_traits>();
  test_read_only_snapshot<transaction_ic3, default_transaction_traits>();
  test_long_keys<transaction_ic3, default_transaction_traits>();
  test_long_keys2<transaction_ic3, default_transaction_traits>();
  test_insert_same_key<transaction_ic3, default_transaction_traits>();

  //mp_stress_test_allocator<transaction_ic3, default_transaction_traits>();
  mp_stress_test_insert_removes<transaction_ic3, default_transaction_traits>();
  mp_test1<transaction_ic3, default_transaction_traits>();
  mp_test2<transaction_ic3, default_transaction_traits>();
  mp_test3<transaction_ic3, default_transaction_traits>();
  mp_test_simple_write_skew<transaction_ic3, default_transaction_traits>();
  mp_test_batch_processing<transaction_ic3, default_transaction_traits>();

  //read_only_perf<transaction_proto1>();
  //read_only_perf<transaction_ic3>();
}
