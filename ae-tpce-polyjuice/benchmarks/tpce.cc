...
tpce_worker::txn_market_feed()
{
    ...
    db->init_txn(txn, nullptr, market_feed_type, policy, pg);
...
tpce_worker::txn_trade_order()
{
    ...
    db->init_txn(txn, nullptr, trade_order_type, policy, pg);
 ...
 *     } */
    ...
    db->init_txn(txn, nullptr, trade_result_type, policy, pg);
...
tpce_worker::txn_trade_update()
{
    ...
    db->init_txn(txn, nullptr, trade_update_type, policy, pg);
