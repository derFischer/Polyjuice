...
class EA:
    def __init__(self, log_dir, kid_dir, selection, pop_size, bfactor, mutate_decay, mut_frac):
        ...
        self.wait_info_act1, self.wait_info_act2, self.wait_info_act3, self.wait_info_act4 = [], [], [], []
        self.reward_buffer = []
    ...
    def mutate(self, sample, decay_rate):
        ...
        mutate_res =  Sample(access, wait, piece, wait_info1, wait_info2, wait_info3, wait_info4, txn_buf_size, backoff)

        return mutate_res

    def store_actions(self, access, wait, piece, wait_info1, wait_info2, wait_info3, wait_info4):
    ...
    def Evaluate(self, round_id, generations, command, load_per_sample):
        ...
        for _, child in enumerate(sample_buffer):
            self.store_actions(child.access, child.wait, child.piece, \
                               child.wait_info1, child.wait_info2, child.wait_info3, child.wait_info4)
    ...
    def rollback(self, index, fail_to_exe):
        ...
        self.wait_info_act4 = self.wait_info_act4[:(index - fail_to_exe) * WAIT_SPACE] + self.wait_info_act4[(index + 1 - fail_to_exe) * WAIT_SPACE :]